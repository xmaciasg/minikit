...
const columnsToAdd = [
  { name: 'broker_commission_rate', type: 'REAL NOT NULL DEFAULT 0' },
  { name: 'agent_commission_rate', type: 'REAL NOT NULL DEFAULT 0' },
  { name: 'broker_commission_usd', type: 'REAL NOT NULL DEFAULT 0' },
  { name: 'agent_commission_usd', type: 'REAL NOT NULL DEFAULT 0' },
];
